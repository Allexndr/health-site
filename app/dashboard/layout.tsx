...
const navigation = [
  ...
  { name: 'Снимки', href: '/dashboard/images', icon: FolderIcon },
  { name: 'Общие снимки', href: '/dashboard/shared', icon: ShareIcon },
  { name: 'Клиники', href: '/dashboard/clinics', icon: UsersIcon },
