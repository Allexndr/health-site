...
const features = [
  {
    ...
    description: 'Ваши медицинские снимки защищены современным шифрованием и хранятся в облачной инфраструктуре мирового уровня.',
    icon: ShieldCheckIcon,
  },
  {
    name: 'Быстрая загрузка',
    description: 'Загружайте снимки до 1ГБ за считанные секунды. Поддержка DICOM, JPEG, PNG форматов.',
    icon: CloudArrowUpIcon,
  },
  {
    name: 'Удобный просмотр',
    description: 'Интуитивная галерея с фильтрами, поиском и возможностью просмотра в полном размере.',
    icon: EyeIcon,
  },
  {
    name: 'Многопользовательский доступ',
    description: 'Индивидуальные аккаунты для каждой клиники с защищённым доступом только к своим данным.',
    icon: UsersIcon,
  },
  {
    name: 'Надёжная инфраструктура',
    description: 'Облачное хранилище с резервным копированием и 99.9% доступности сервиса.',
    icon: ServerIcon,
  },
  {
    name: 'Полная конфиденциальность',
    description: 'Каждая клиника видит только свои снимки. Строгое соблюдение медицинской тайны.',
    icon: LockClosedIcon,
  },
]

const stats = [
  { id: 1, name: 'Клиник в сети', value: '50+' },
  { id: 2, name: 'Загруженных снимков', value: '10,000+' },
  { id: 3, name: 'Объём данных', value: '5+ ТБ' },
        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              ...
              <span className="text-blue-600">медицинских снимков</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              Индивидуальный доступ, быстрая загрузка, полная конфиденциальность.
            </p>
      ...
      <div id="features" className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-blue-600">Профессиональное решение</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Всё, что нужно для работы с медицинскими снимками
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Наша платформа обеспечивает безопасное хранение, быстрый доступ и удобное управление медицинскими изображениями 
        ...
        <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-blue-100">
              Получите доступ к вашему защищённому хранилищу медицинских снимков. 
              Войдите в систему, используя данные вашей клиники.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/auth/login"
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <div className="flex items-center justify-center md:justify-start space-x-2">
              ...
              <span className="text-sm text-gray-400">
                &copy; 2025 MedImage Cloud. Профессиональное решение для медицинских учреждений.
              </span>
            </div>
          </div>
        </div>
